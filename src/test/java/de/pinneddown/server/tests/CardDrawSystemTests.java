...
public class CardDrawSystemTests {
    ...
    @Test
    void playersDiscardCardsFromEffects() {
        // ARRANGE
        EventManager eventManager = new EventManager();
        EntityManager entityManager = new EntityManager(eventManager);
        ...
        CardDiscardComponent cardDiscardComponent = new CardDiscardComponent();
        cardDiscardComponent.setDiscardedRandomCards(1);
        entityManager.addComponent(effectEntityId, cardDiscardComponent);
        ...
        // ASSERT
        assertThat(playerComponent.getHand().size()).isLessThan(cardsInHand);
    }
